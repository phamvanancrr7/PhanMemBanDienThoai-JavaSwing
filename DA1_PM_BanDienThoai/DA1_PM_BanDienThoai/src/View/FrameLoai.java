 ...
 * @author ADMIN
 */
public class FrameLoai extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameLoai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
